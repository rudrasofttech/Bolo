...
namespace Bolo.Migrations
{
    ...
    [Migration("20200810100007_Instagram")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bolo.Models.Follower", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bolo.Models.Post", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bolo.Models.PostComment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bolo.Models.PostLike", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bolo.Models.Follower", b =>
                {
                    b.HasOne("Bolo.Models.Member", "FollowedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Bolo.Models.PostComment", b =>
                {
                    ...
                    b.HasOne("Bolo.Models.Post", "Post")
                        .WithMany()
