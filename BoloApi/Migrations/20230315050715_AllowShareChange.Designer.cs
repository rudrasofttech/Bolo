...
namespace Bolo.Migrations
{
    ...
    [Migration("20230315050715_AllowShareChange")]
    partial class AllowShareChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bolo.Models.SharedPost", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bolo.Models.SharedPost", b =>
                {
                    ...
                    b.HasOne("Bolo.Models.Member", "SharedBy")
                        .WithMany()
                        .HasForeignKey("SharedByID");

                    b.HasOne("Bolo.Models.Member", "SharedWith")
                        .WithMany()
