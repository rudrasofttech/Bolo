    ...
    render() {
        return <React.Fragment ><main role="main" className="inner cover" style={{ padding : "20px"}}>
            ...
            <p>
                ...
                website with regards to the information that they shared and/or collect in Waarta. This policy is not
            ...
            <p>
                Waarta follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            <p>
                Like any other website, Waarta uses 'cookies'. These cookies are used to store information including
            ...
            <p>
                ...
                used in their respective advertisements and links that appear on Waarta, which are sent directly to users'
            ...
            <p>Note that Waarta has no access to or control over these cookies that are used by third-party advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>
                Waarta's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>
                Waarta does not knowingly collect any Personal Identifiable Information from children under the age of 13.
