                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <div className="input-group">
                                ...
                                <button className="btn btn-secondary" onClick={() => { this.saveData("visibility", this.state.myself.visibility) }}>Save</button>
                            </div>
                        </div>
                        <div className="col-md-6">
                            ...
                            <div className="input-group">
                                ...
                                <button className="btn btn-secondary" onClick={() => { this.saveData("country", this.state.myself.country) }}>Save</button>
                            </div>
                        </div>
                    </div>
                    <div className="row">
